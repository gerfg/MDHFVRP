...
MyLazyCallback::MyLazyCallback(IloEnv env, const IloArray<IloArray<IloArray<IloBoolVarArray>> >& x_ref, Data* data) : IloCplex::LazyConstraintCallbackI(env), x(x_ref), data(data)
{} 
